 ...
 * @author Mihailo
 */
public class ThinningFilter implements ImageFilter {

    private BufferedImage originalImage;
    private BufferedImage filteredImage;

    private boolean blackLetters = true;
    private boolean isGuoHall = false;
    ...
    public BufferedImage processImage(BufferedImage image) {
        ...
        //iterativni deo treba promeniti
        ...
        for (int i = 0; i < width; i++) {
            for (int j = 0; j < height; j++) {
                ...
                if (blackLetters)
                    ...
                    col = imageM[i][j] * 255;
                int rgb = PreprocessingHelper.colorToRGB(alpha, col, col, col);
...
//                     (p8 == 0 && p9 == 1) + (p9 == 0 && p2 == 1); 
    ...
    public void setIsGuoHall(boolean isGuoHall) {
        this.isGuoHall = isGuoHall;
    }
